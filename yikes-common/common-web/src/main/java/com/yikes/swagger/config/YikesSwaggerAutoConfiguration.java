package com.yikes.swagger.config;
 ...
 *
 * @author guanrong.yin
 * @date 2023/9/28 22:41
 */
@AutoConfiguration
@ConditionalOnClass({Docket.class})
@EnableConfigurationProperties(SwaggerProperties.class)
@ConditionalOnProperty(prefix = "springdoc.api-docs", name = "enabled", havingValue = "true", matchIfMissing = true) // 设置为 false 时，禁用
public class YikesSwaggerAutoConfiguration {

    public static final String HEADER_TENANT_ID = "org_id";
...
//    public Docket docketBean(SwaggerProperties properties) {
//
...
//                
//                //这里指定Controller扫描包路径
//                .apis(RequestHandlerSelectors.basePackage(properties.getUrl()))
